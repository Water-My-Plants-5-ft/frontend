                        ...
                        <div className='plantPicOptions-Container'>
                            <div className='plantPicOption-Container'>
                                ...
                                <label
                                    for='plant1'
                                    id='plantPic1'>
                                    <img src={plant1} alt='plant1'className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant2'
                                    id='plantPic2'>
                                    <img src={plant2} alt='plant2' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant3'
                                    id='plantPic3'>
                                    <img src={plant3} alt='plant3' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant4'
                                    id='plantPic4'>
                                    <img src={plant4} alt='plant4' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant5'
                                    id='plantPic5'>
                                    <img src={plant5} alt='plant5' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant6'
                                    id='plantPic6'>
                                    <img src={plant6} alt='plant6' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant7'
                                    id='plantPic7'>
                                    <img src={plant7} alt='plant7' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant8'
                                    id='plantPic8'>
                                    <img src={plant8} alt='plant8' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant9'
                                    id='plantPic9'>
                                    <img src={plant9} alt='plant9' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant10'
                                    id='plantPic10'>
                                    <img src={plant10} alt='plant10' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant11'
                                    id='plantPic11'>
                                    <img src={plant11} alt='plant11' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                            <div className='plantPicOption-Container'>
                                <input
                                ...
                                <label
                                    for='plant12'
                                    id='plantPic12'>
                                    <img src={plant12} alt='plant12' className='plantPicOption-Image'></img>
                                </label>
                            </div>
                        </div>
                </div>
